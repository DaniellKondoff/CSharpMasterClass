namespace References
{
    ...
    public static class Program
    {
        public static void Main()
        {
            ...
            Console.WriteLine("firstPerson == secondPerson is {0}", firstPerson == secondPerson);//false
            Console.WriteLine();

            var thirdPerson = secondPerson;
            Console.WriteLine("var thirdPerson = secondPerson;");
            Console.WriteLine("thirdPerson == secondPerson is {0}", thirdPerson == secondPerson); //true
            Console.WriteLine();
