...
namespace ExpressionTreeDemo
{
    public class PropertyHelper
    {
        ...
        private static readonly ConcurrentDictionary<Type, PropertyHelper[]> PropertiesCache = new ConcurrentDictionary<Type, PropertyHelper[]>();
        ...
        public static PropertyHelper[] Get<T>(T obj)
        {
            ...
            return PropertiesCache.GetOrAdd(type, _ =>
            {
                ...
                {
                    //object obj
                    var parameter = Expression.Parameter(TypeOfObject, pr.Name);
